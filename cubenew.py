...
# white :    [84,0,203],[171,46,255]
# yellow :   [21,53,160],[57,202,255]
# orange :   [0,73,255],[20,184,255]
# red :      [0,161,196],[179,255,255]
# green :    [45,46,200],[97,139,255]
# blue :     [95,133,230],[117,255,255]
            #[0,110,203],[45,255,253]   red new
            #[97,148,226],[116,255,255]   blue new
...
print(rf"          ______    __     __    _________    _________                                   ___ ___ ___             ")
print(rf"         |  ____|  |  |   |  |  |  _____  |  | ________|                                 |   |   |   |            ")
print(rf"         | |       |  |   |  |  | |_____| |  | |____                                     |___|___|___|            ")
print(rf"         | |       |  |   |  |  |  _____  |  |  ____|                                    |   |   |   |            ")
print(rf"         | |____   |  |___|  |  | |_____| |  | |_______                                  |_ _|_ _|_ _|            ")
print(rf"         |______|  |_________|  |_________|  |_________|                                 |   |   |   |            ")
print(rf"                                                                                         |___|___|___|            ")    
print(rf"                            _______    _________    __      ___      ___   ________    ________                   ",end='\n')
print(rf"                           |  _____|  |   ___   |  |  |     \  \    /  /  |  ______|  |  _____ |                  ")
print(rf"                           | |_____   |  |   |  |  |  |      \  \  /  /   | |____     |  ______|                  ")
print(rf"                           |_____  |  |  |   |  |  |  |       \  \/  /    |  ____|    |   \  \                    ")
print(rf"                            _____| |  |  |___|  |  |  |____    \    /     | |______   |  | \  \                   ")
print(rf"                           |_______|  |_________|  |_______|    \__/      |________|  |__|  \__\                  ")

time.sleep(2)
print("")
print("")
print(f"Please refer preview window for which side you have scanned and which color should be in centre on each side. ")

#input all cube values as white
state=  {
...
#assign cordinates for each cube on ans frame
stickers = {
        'main': [
...
# add text in middle of cube value
textPoints=  {
...
def color_detect(h, s, v):
    if 84 <= h <= 171 and 0 <= s <= 46 and 203 <= v <= 255:
        return 'white'
    elif 21 <= h <= 57 and 53 <= s <= 202 and 160 <= v <= 255:
        return 'yellow'
    elif 0 <= h <= 20 and 73 <= s <= 184 and 255 <= v <= 255:
        return 'orange'
    elif 95 <= h <= 117 and 133 <= s <= 255 and 230 <= v <= 255:
        return 'blue'
    elif 0 <= h <= 179 and 161 <= s <= 255 and 196 <= v <= 255:
        return 'red'
    elif 45 <= h <= 97 and 46 <= s <= 139 and 200 <= v <= 255:
        return 'green'
    return 'white'

#small rectangles to detect frame
